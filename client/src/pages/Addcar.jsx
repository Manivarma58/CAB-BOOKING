...
import { ArrowLeft, Car, User, Shield, IndianRupee, Upload, Plus } from 'lucide-react';
    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="text-left mb-6">
          <Link to="/admin/cabs" className="inline-flex items-center gap-1 text-sm font-semibold text-slate-550 hover:text-slate-900 transition">
            <ArrowLeft className="h-4 w-4" /> Back to Cabs
          </Link>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight mt-2">Add New Vehicle</h1>
          <p className="text-slate-500 text-sm">Register a new driver and car mapping to the fleet.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left" encType="multipart/form-data">
            ...
            >
              {loading ? (
                ...
                <>
                  <Plus className="h-4 w-4 stroke-[2.5]" /> Register New Cab
                </>
              )}
            </button>
          </form>
